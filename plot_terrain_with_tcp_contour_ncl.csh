...
begin
 ...
 ; ===== read 3d pressure file =======
  ...
  res@mpLeftCornerLonF  = 34
  res@mpRightCornerLatF = 34
  res@mpRightCornerLonF = 36
  ; ======= box 1 ==========
  ...
  ; ======= box 2b =========
  ;res@mpLeftCornerLatF  = 34.5
  ;res@mpLeftCornerLonF  = 34.5
  ;res@mpRightCornerLatF = 36.1
  ;res@mpRightCornerLonF = 36.5
  ...
  ; ===== my box ======
  vecres@mpLeftCornerLatF  = 29
  vecres@mpLeftCornerLonF  = 34
  vecres@mpRightCornerLatF = 34
  vecres@mpRightCornerLonF = 36
  ...
  ; ======= box 2b =========
  ;vecres@mpLeftCornerLatF  = 34.5
  ;vecres@mpLeftCornerLonF  = 34.5
  ;vecres@mpRightCornerLatF = 36.1
  ;vecres@mpRightCornerLonF = 36.5
  ...
  print("set lat/lon corners manually")
  ; ====== WC: define title ====
  ...
  ; ===== my box ======
  conres@mpLeftCornerLatF  = 29
  conres@mpLeftCornerLonF  = 34
  conres@mpRightCornerLatF = 34
  conres@mpRightCornerLonF = 36
  ...
  ; ======= box 2b =========
  ;conres@mpLeftCornerLatF  = 34.5
  ;conres@mpLeftCornerLonF  = 34.5
  ;conres@mpRightCornerLatF = 36.1
  ;conres@mpRightCornerLonF = 36.5
...
mv raster.jpg terrain_tcp_${TIME_INDEX}_${DOMAIN}.jpg
